 ...
 * @author  STARK-PC
 */
public class EncryptionForm_1 extends javax.swing.JFrame {
    private File inputFile;
    private File outDirectory;


    /** Creates new form EncryptionForm */
    public EncryptionForm_1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        statusDisplay.setBackground(new java.awt.Color(204, 204, 255));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        boolean flag = new CHECK().CHECKT(1,s1,statusDisplay);
        if(flag)
        {
