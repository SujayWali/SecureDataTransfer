 ...
 */
public class DecryptionForm_1 extends javax.swing.JFrame {
    private File inputFile;
    private File outDirectory;
         

    /** Creates new form EncryptionForm */
    public DecryptionForm_1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("video Stegnography---Decryption Form");
        setResizable(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        boolean flag=new CHECK().CHECKT(2,s1,statusDisplay); 
        if(flag) 
        {
